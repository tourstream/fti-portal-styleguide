...
## 0.51.1
- Hides `<hr>` elements inside `.teaser-list`'s.
...
## 0.48.1
- Adapts Headlines' margin-bottoms

## 0.48.0
- Defines z-indexes and documents them
- Fixes z-index for French Quicksearch
- Defines functions and map to map through defined z-indexes
